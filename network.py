...
class DewarpingNet(nn.Module):
    def __init__(self):
        super(DewarpingNet, self).__init__()
        self.conv1 = nn.Conv2d(in_channels=3, out_channels=6, kernel_size=3, stride=1, padding=0)   # 彩色图像输入�? 3 �?, 我们想让它的输出�? 6 �?, �? 3 * 3 的卷�?
